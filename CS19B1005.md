...
```
 ...
 ## Inline functions
 In Inline function, The compiler places a copy of the code of that function at each point where the function is called at compile time.Inline functions is to reduce the function call overhead
